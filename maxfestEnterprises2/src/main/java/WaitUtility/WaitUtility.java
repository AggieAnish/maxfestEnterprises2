...
public void WaitUntilelementToBeClickable(WebElement value,int sec) {
	WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(sec));
	wait.until(ExpectedConditions.elementToBeClickable(value));
}
public void WaitUntilalertIsPresent(WebElement value,int sec) {
	WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(sec));
	wait.until(ExpectedConditions.alertIsPresent());
}

public void WaitUntilvisibilityOf(By value,int sec) {
	WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(sec));
	wait.until(ExpectedConditions.visibilityOf(null));
}
@SuppressWarnings({ "rawtypes", "unchecked" })
public void WaitTillalertIsPresent(int timeout, int polling) {
