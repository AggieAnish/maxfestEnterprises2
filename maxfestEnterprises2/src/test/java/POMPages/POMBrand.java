...
public class POMBrand {
	...
	public void brandMenuClick() throws InterruptedException {
		 wait.waitUntil(2000);
		action.click(brandMenu);
	}

	public void brandAddBrandName(String value) throws InterruptedException {
		 wait.waitUntil(2000);
		action.sendkeys(brandName, value);
	}

	public void brandAddbtnClick() throws InterruptedException {
		 wait.waitUntil(2000);
		action.click(brandAddBtn);
	}

	public void brandAddShortDesc(String value) throws InterruptedException {
		 wait.waitUntil(2000);
		action.sendkeys(brandShortDecription, value);
	}

	public void brandSaveBtnClick() throws InterruptedException {
		 wait.waitUntil(2000);
		action.click(brandSaveBtn);
	}

	public void brandSearchInputClick() throws InterruptedException {
		 wait.waitUntil(2000);
		action.click(brandSearchInput);
	}

	public void brandSearchInputAdd(String value) throws InterruptedException {
		 wait.waitUntil(2000);
		action.sendkeys(brandSearchInput, value);
	}

	public String getBrandTablevalue() throws InterruptedException {
		wait.waitUntil(2000);
	...
	public void brandDeleteBtnClick() throws InterruptedException {
		 wait.waitUntil(2000);
		action.click(brandDeleteBtn);		
	}
	
	public void brandDeleteAlertBtnClick() throws InterruptedException {
		 wait.waitUntil(2000);
	...
	public String getbrandaddToastmsg( ) throws InterruptedException {
		wait.waitUntil(2000);
	...
	public String getbranddeleteToastmsg( ) throws InterruptedException {
		 wait.waitUntil(2000);
