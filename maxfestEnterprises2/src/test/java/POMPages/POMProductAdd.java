...
public class POMProductAdd {
	...
	public void addpurchaseExcTax(String value) throws InterruptedException {
		wait.waitUntil(2000);
	...
	public void addexpiry(String value) throws InterruptedException {
		wait.waitUntil(2000);
		action.sendkeys(expiry, value);
	}

	public void productSaveBtnClick() throws InterruptedException {
		wait.waitUntil(2000);
		action.click(productSaveBtn);
	}

	public String getSaveToastValue() throws InterruptedException {
		wait.waitUntil(2000);
